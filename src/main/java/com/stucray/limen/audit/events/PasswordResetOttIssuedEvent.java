 ...
 * {@link VerificationOttIssuedEvent}: the controller-level response is
 * identical for known and unknown emails (no user-existence oracle), and the
 * audit row's {@code delivered} flag is the only place the distinction
 * surfaces.
 */

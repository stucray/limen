...
<!-- coverage:auto:start -->
**Generated:** 2026-05-30 from commit `4b1579c` (current `main`). Δ columns compare against the PR #59 baseline (commit `e2fcdb0`) and the previous snapshot in `test-coverage-history.jsonl`.

**Run:** `./mvnw verify` — 567 tests, all passing. JaCoCo analyzes 192 production classes.

## Headline numbers

| Metric       | Coverage | Δ from baseline | Δ from prev | Covered / Total |
|--------------|---------:|----------------:|------------:|----------------:|
| Instructions | 92.8 % | +8.8 % 🟢 | -1.3 % 🔴 | 13,367 / 14,400 |
| Branches     | 75.6 % | +5.6 % 🟢 | -2.5 % 🔴 | 655 / 866 |
| Lines        | 93.3 % | +7.2 % 🟢 | -1.1 % 🔴 | 2,708 / 2,901 |
| Methods      | 94.3 % | +5.2 % 🟢 | -0.9 % 🔴 | 734 / 778 |

...
**Run:** `./mvnw verify` — 473 tests, all passing. JaCoCo analyzes 179 production classes.

## Headline numbers

| Metric       | Coverage | Δ from baseline | Δ from prev | Covered / Total |
|--------------|---------:|----------------:|------------:|----------------:|
| Instructions | 93.7 % | +9.7 % 🟢 | +0.2 % 🟢 | 12,234 / 13,054 |
| Branches     | 77.9 % | +7.9 % 🟢 | +0.5 % 🟢 | 569 / 730 |
| Lines        | 94.1 % | +8.0 % 🟢 | +0.2 % 🟢 | 2,487 / 2,643 |
| Methods      | 94.7 % | +5.6 % 🟢 | +0.2 % 🟢 | 661 / 698 |
...
| com.stucray.limen.oauth2 | 95.7 % | +7.9 % 🟢 | -0.1 % 🔴 | 83.3 % | 98.6 % | 15 |
| com.stucray.limen.memberships | 98.1 % | +98.1 % 🟢 | +0.0 % ⚪ | 83.8 % | 91.0 % | 6 |
| com.stucray.limen.auth.login | 98.5 % | +98.5 % 🟢 | -0.9 % 🔴 | 88.2 % | 96.8 % | 3 |

...
<!-- coverage:auto:start -->
**Generated:** 2026-05-11 from commit `88ccebc` (current `main`). Δ columns compare against the PR #59 baseline (commit `e2fcdb0`) and the previous snapshot in `test-coverage-history.jsonl`.

**Run:** `./mvnw verify` — 511 tests, all passing. JaCoCo analyzes 180 production classes.

## Headline numbers

| Metric       | Coverage | Δ from baseline | Δ from prev | Covered / Total |
|--------------|---------:|----------------:|------------:|----------------:|
| Instructions | 93.7 % | +9.7 % 🟢 | +0.0 % ⚪ | 12,230 / 13,051 |
| Branches     | 77.9 % | +7.9 % 🟢 | +0.4 % 🟢 | 567 / 728 |
| Lines        | 94.1 % | +8.0 % 🟢 | -0.1 % 🔴 | 2,483 / 2,639 |
| Methods      | 94.7 % | +5.6 % 🟢 | +0.0 % ⚪ | 660 / 697 |
...
| com.stucray.limen.oauth2 | 97.7 % | +9.9 % 🟢 | -0.1 % 🔴 | 88.9 % | 100.0 % | 4 |

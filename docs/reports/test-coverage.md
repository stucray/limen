...
<!-- coverage:auto:start -->
**Generated:** 2026-05-16 from commit `1c19168` (current `main`). Δ columns compare against the PR #59 baseline (commit `e2fcdb0`) and the previous snapshot in `test-coverage-history.jsonl`.

...
<!-- coverage:auto:start -->
**Generated:** 2026-07-20 from commit `490d672` (current `main`). Δ columns compare against the PR #59 baseline (commit `e2fcdb0`) and the previous snapshot in `test-coverage-history.jsonl`.

**Run:** `./mvnw verify` — 620 tests, all passing. JaCoCo analyzes 195 production classes.

## Headline numbers

| Metric       | Coverage | Δ from baseline | Δ from prev | Covered / Total |
|--------------|---------:|----------------:|------------:|----------------:|
| Instructions | 94.1 % | +10.1 % 🟢 | +0.0 % ⚪ | 13,804 / 14,666 |
| Branches     | 78.3 % | +8.3 % 🟢 | +0.2 % 🟢 | 692 / 884 |
| Lines        | 94.4 % | +8.3 % 🟢 | +0.0 % ⚪ | 2,791 / 2,957 |
| Methods      | 95.2 % | +6.1 % 🟢 | +0.0 % ⚪ | 755 / 793 |
...
| com.stucray.limen.oauth2 | 97.3 % | +9.5 % 🟢 | -0.4 % 🔴 | 86.7 % | 100.0 % | 5 |
| com.stucray.limen.auth.login | 98.0 % | +98.0 % 🟢 | -0.6 % 🔴 | 88.6 % | 96.2 % | 5 |
...
| com.stucray.limen.provisioning | 100.0 % | +100.0 % 🟢 | +0.0 % ⚪ | 92.5 % | 100.0 % | 0 |

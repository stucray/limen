...
**Run:** `./mvnw verify` — 543 tests, all passing. JaCoCo analyzes 184 production classes.

## Headline numbers

| Metric       | Coverage | Δ from baseline | Δ from prev | Covered / Total |
|--------------|---------:|----------------:|------------:|----------------:|
| Instructions | 93.9 % | +9.9 % 🟢 | +0.0 % ⚪ | 12,491 / 13,303 |
| Branches     | 78.8 % | +8.8 % 🟢 | +0.0 % ⚪ | 599 / 760 |
| Lines        | 94.2 % | +8.1 % 🟢 | +0.0 % ⚪ | 2,532 / 2,687 |
| Methods      | 94.8 % | +5.7 % 🟢 | +0.0 % ⚪ | 677 / 714 |

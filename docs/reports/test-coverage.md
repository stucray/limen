...
<!-- coverage:auto:start -->
**Generated:** 2026-05-17 from commit `2c81306` (current `main`). Δ columns compare against the PR #59 baseline (commit `e2fcdb0`) and the previous snapshot in `test-coverage-history.jsonl`.
...
| com.stucray.limen.oauth2.sas | 93.7 % | +93.7 % 🟢 | +0.0 % ⚪ | 78.1 % | 97.4 % | 11 |
